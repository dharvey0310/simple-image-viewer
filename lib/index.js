...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImageViewer = function (_Component) {
	    ...
	    function ImageViewer(props) {
	        ...
	        _this.state = { currentIndex: _this.props.index, translateValue: 0 };
	        return _this;
	    }
	    ...
	    _createClass(ImageViewer, [{
	        ...
	        value: function loadPreviousImage() {
	            ...
	            this.setState({ translateValue: "-150%" }, function () {
	                return setTimeout(function () {
	                    return _this4.setState({ currentIndex: _this4.state.currentIndex - 1, translateValue: 0 });
	                }, 1000);
	            });
	        }
	    }, {
	        ...
	        value: function loadNextImage() {
	            ...
	            this.setState({ translateValue: "150%" }, function () {
	                return setTimeout(function () {
	                    return _this5.setState({ currentIndex: _this5.state.currentIndex + 1, translateValue: 0 });
	                }, 1000);
	            });
	        }
	    }, {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('img', { src: this.props.images[this.state.currentIndex], className: '' + (this.props.imageClass ? this.props.imageClass : ""), style: this.props.imageStyles ? this.props.imageStyles : { transform: 'translateX(' + this.state.translateValue + ')', transition: "transform 0.5s linear" } })
	                    ),
