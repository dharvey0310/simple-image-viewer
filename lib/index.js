	...
	var ImageViewer = function (_Component) {
	    ...
	    _createClass(ImageViewer, [{
	        ...
	        value: function imageLoaded() {
	            ...
	            setTimeout(function () {
	                return _this4.setState({ loading: false, translateValue: 0, opacity: 1, transition: "transform 0.4s ease-out, opacity 0.3s ease-out" });
	            }, 500);
	        }
	    }, {
	        ...
	        value: function loadPreviousImage() {
	            ...
	            if (this.state.currentIndex > 0) {
	                this.setState({ translateValue: "200%", loading: true, transition: "transform 0.4s ease-out" }, function () {
	                    return setTimeout(function () {
	                        return _this5.setState({ error: false, currentIndex: _this5.state.currentIndex - 1, translateValue: "-200%", opacity: 0 });
	                    }, 500);
	                });
	            }
	        }
	        ...
	        value: function loadNextImage() {
	            ...
	            if (this.state.currentIndex !== this.length) {
	                this.setState({ translateValue: "-200%", loading: true, transition: "transform 0.4s ease-out" }, function () {
	                    return setTimeout(function () {
	                        return _this6.setState({ error: false, currentIndex: _this6.state.currentIndex + 1, translateValue: "200%", opacity: 0 });
	                    }, 500);
	                });
	            }
	        }
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                { onSwipedRight: function onSwipedRight() {
	                        return _this7.loadPreviousImage();
	                    }, onSwipedLeft: function onSwipedLeft() {
	                        return _this7.loadNextImage();
	                    } },
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'siv-img-container', style: this.state.loading ? { background: 'transparent url(' + _default2.default + ') center no-repeat' } : {} },
	                        !this.state.error ? _react2.default.createElement('img', { onLoad: function onLoad() {
	                                return _this7.imageLoaded();
	                            }, onError: function onError() {
	                                return _this7.imageError();
	                            }, src: this.props.images[this.state.currentIndex], className: '' + (this.props.imageClass ? this.props.imageClass : ""), style: this.getImageStyles() }) : _react2.default.createElement('img', { src: _2.default, style: this.getImageStyles() })
	                    ),
	                    !this.props.hideArrows ? _react2.default.createElement(
	                        'div',
