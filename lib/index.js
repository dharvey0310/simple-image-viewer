	  ...
	  _createClass(ImageViewer, [{
	      ...
	      if (this.state.currentIndex > 0) {
	        this.setState({ translateValue: '200%', loading: true, transition: 'transform 0.4s ease-out' }, function () {
	          return setTimeout(function () {
	            return _this3.setState({ error: false, currentIndex: _this3.state.currentIndex - 1, translateValue: '-200%', opacity: 0 });
	          }, 500);
	        });
	      }
	    }
	    ...
	    value: function loadNextImage() {
	      ...
	      if (this.state.currentIndex !== this.length) {
	        this.setState({ translateValue: '-200%', loading: true, transition: 'transform 0.4s ease-out' }, function () {
	          return setTimeout(function () {
	            return _this4.setState({ error: false, currentIndex: _this4.state.currentIndex + 1, translateValue: '200%', opacity: 0 });
	          }, 500);
	        });
	      }
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        { onSwipedRight: function onSwipedRight() {
	            return _this5.loadPreviousImage();
	          }, onSwipedLeft: function onSwipedLeft() {
	            return _this5.loadNextImage();
	          } },
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            {
	              ...
	              style: this.state.loading || this.props.forceLoadSpinner ? { background: 'transparent url(' + _default2.default + ') center no-repeat' } : {} },
	            !this.state.error ? _react2.default.createElement('img', {
	              onLoad: function onLoad() {
	                return _this5.imageLoaded();
	              },
	              onError: function onError() {
	                return _this5.imageError();
	              },
	              src: this.props.images[this.state.currentIndex],
	              className: '' + (this.props.imageClass ? this.props.imageClass : ''),
	              style: this.getImageStyles()
	            }) : _react2.default.createElement('img', { src: _2.default, style: this.getImageStyles() })
	          ),
	          !this.props.hideArrows ? _react2.default.createElement(
	            'div',
	        ...
	        !this.props.hideClose ? _react2.default.createElement(
	          ...
	          _react2.default.createElement(_io.IoCloseRound, { style: this.getCloseStyles(), onClick: function onClick() {
	              return _this5.props.handleClose();
	            } })
	        ) : null
	      );
	    }
