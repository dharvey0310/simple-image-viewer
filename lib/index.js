...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImageViewer = function (_Component) {
	    ...
	    function ImageViewer(props) {
	        ...
	        _this.state = { currentIndex: _this.props.index, translateValue: 0, visibility: "visible", opacity: 1 };
	        return _this;
	    }
	    ...
	    _createClass(ImageViewer, [{
	        ...
	        value: function loadPreviousImage() {
	            ...
	            if (this.state.currentIndex > 0) {
	                this.setState({ translateValue: "200%" }, function () {
	                    return setTimeout(function () {
	                        return _this4.setState({ currentIndex: _this4.state.currentIndex - 1, translateValue: "-200%", visibility: "hidden", opacity: 0 }, function () {
	                            return setTimeout(function () {
	                                return _this4.setState({ visibility: "visible", translateValue: 0, opacity: 1 });
	                            }, 500);
	                        });
	                    }, 500);
	                });
	        ...
	        value: function loadNextImage() {
	            ...
	            if (this.state.currentIndex !== this.length) {
	                this.setState({ translateValue: "-200%" }, function () {
	                    return setTimeout(function () {
	                        return _this5.setState({ currentIndex: _this5.state.currentIndex + 1, translateValue: "200%", visibility: "hidden", opacity: 0 }, function () {
	                            return setTimeout(function () {
	                                return _this5.setState({ visibility: "visible", translateValue: 0, opacity: 1 });
	                            }, 500);
	                        });
	                    }, 500);
	                });
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'siv-img-container', style: { background: 'transparent url(' + _default2.default + ') center no-repeat' } },
	                        _react2.default.createElement('img', { src: this.props.images[this.state.currentIndex], className: '' + (this.props.imageClass ? this.props.imageClass : ""), style: this.getImageStyles() })
	                    ),
	                    !this.props.hideArrows ? _react2.default.createElement(
	                        'div',
	                        null,
