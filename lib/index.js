	    ...
	    _createClass(ImageViewer, [{
	        ...
	        value: function loadPreviousImage() {
	            ...
	            if (this.state.currentIndex > 0) {
	                this.setState({ error: false, translateValue: "200%", loading: true, transition: "transform 0.4s ease-out" }, function () {
	                    return setTimeout(function () {
	                        return _this5.setState({ currentIndex: _this5.state.currentIndex - 1, translateValue: "-200%", opacity: 0 });
	                    }, 500);
	                });
	            }
	        }
	        ...
	        value: function loadNextImage() {
	            ...
	            if (this.state.currentIndex !== this.length) {
	                this.setState({ error: false, translateValue: "-200%", loading: true, transition: "transform 0.4s ease-out" }, function () {
	                    return setTimeout(function () {
	                        return _this6.setState({ currentIndex: _this6.state.currentIndex + 1, translateValue: "200%", opacity: 0 });
	                    }, 500);
	                });
	            }
	        }
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        !this.state.error ? _react2.default.createElement('img', { onLoad: function onLoad() {
	                            ...
	                            }, src: this.props.images[this.state.currentIndex], className: '' + (this.props.imageClass ? this.props.imageClass : ""), style: this.getImageStyles() }) : _react2.default.createElement('img', { src: _2.default })
	                    ),
	                    !this.props.hideArrows ? _react2.default.createElement(
	                        'div',
