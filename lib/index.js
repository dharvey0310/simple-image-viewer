...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImageViewer = function (_Component) {
	    ...
	    function ImageViewer(props) {
	        ...
	        _this.state = { currentIndex: _this.props.index, translateValue: 0, visibility: "visible", opacity: 1, loading: true };
	        return _this;
	    }
	    ...
	    _createClass(ImageViewer, [{
	        ...
	        value: function imageLoaded() {
	            ...
	            setTimeout(function () {
	                return _this4.setState({ loading: false, translateValue: 0, visibility: "visible", opacity: 1 });
	            }, 500);
	        }
	    }, {
	        ...
	        value: function loadPreviousImage() {
	            ...
	            if (this.state.currentIndex > 0) {
	                this.setState({ translateValue: "200%", loading: true }, function () {
	                    return setTimeout(function () {
	                        return _this5.setState({ currentIndex: _this5.state.currentIndex - 1, translateValue: "-200%", visibility: "hidden", opacity: 0 });
	                    }, 500);
	                });
	            }
	        }
	        ...
	        value: function loadNextImage() {
	            ...
	            if (this.state.currentIndex !== this.length) {
	                this.setState({ translateValue: "-200%", loading: true }, function () {
	                    return setTimeout(function () {
	                        return _this6.setState({ currentIndex: _this6.state.currentIndex + 1, translateValue: "200%", visibility: "hidden", opacity: 0 });
	                    }, 500);
	                });
	            }
	        }
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('img', { onLoad: function onLoad() {
	                            ...
	                            }, src: this.props.images[this.state.currentIndex], className: '' + (this.props.imageClass ? this.props.imageClass : ""), style: this.getImageStyles() })
	                    ),
	                    !this.props.hideArrows ? _react2.default.createElement(
	                        'div',
	                        null,
